...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Aryan11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Aryan Rajpooy",
    BOT_NAME: process.env.BOT_NAME || 'Rajpoot bot',
    ...
    SUDO: process.env.SUDO || "923151595788",
