...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '_EXCEL_;EXCEL;0;https://i.imgur.com/uZy4heK.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "EXCEL",
    BOT_NAME: process.env.BOT_NAME || 'EXCEL',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭EXCELꫂ;EXCEL MD bot;https://i.imgur.com/uZy4heK.jpg' : process.env.AUDIO_DATA,
