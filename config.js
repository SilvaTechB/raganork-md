...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝙰𝚌 𝙼𝚘𝚍𝚜;𝙰𝚌 𝙼𝚘𝚍𝚜;212614389153;https://i.imgur.com/uqECMgu.jpg',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝙰𝚌 𝙼𝚘𝚍𝚜',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '𝚫𝐂 𝚳𝚯𝐃𝐒;https://telegra.ph/file/9faa65d7776901216c238.jpg' : process.env.AUDIO_DATA,
