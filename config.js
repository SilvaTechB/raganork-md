...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '『B』『O』『T』;『B』『O』『T』;+24176500014;https://i.imgur.com/GVxGOpn.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'ON',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "『B』『O』『T』",
    BOT_NAME: process.env.BOT_NAME || '『B』『O』『T』',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "Public" ? '『B』『O』『T』;『B』『O』『T』;https://i.imgur.com/GVxGOpn.jpg' : process.env.AUDIO_DATA,
