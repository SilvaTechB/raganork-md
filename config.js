...
module.exports = {
    VERSION: 'V1.0.2',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/b9faf3acf140ccc725117.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐀𝐫𝐜𝐭𝐢𝐱;𝐀𝐫𝐜𝐞𝐮𝐬;919337956084;https://telegra.ph/file/b9faf3acf140ccc725117.jpg;https://chat.whatsapp.com/Kb6msWfU8fP25KcG3M4Xtw',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212,44',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Arctix Ai',
