...
module.exports = {
    VERSION: 'V 2.0.1',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg  {pp} Active since {uptime}
 User:{sender}

MY QUOTE FOR YOU
{quote}

 https://i.imgur.com/QgIMf8b.jpeg
...
#cbutton\contact owner# #url\https.//wa.me/+2348100236360",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Alien;Souravkl11;916282344739;https://i.imgur.com/st4R2dq.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || 'oXp5rrLTv78T87YK3tZNSPb3',
    ...
    SUDO: process.env.SUDO || "+2348100236360,+2348096513251",
